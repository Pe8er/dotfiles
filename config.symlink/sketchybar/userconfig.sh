...
P_DYNAMIC_ISLAND_DEFAULT_HEIGHT=30
P_DYNAMIC_ISLAND_DEFAULT_WIDTH=170
P_DYNAMIC_ISLAND_DEFAULT_CORNER_RADIUS=16

# Animation Settings
P_DYNAMIC_ISLAND_SQUISH_AMOUNT=0

#
## App Switch Island config
#
P_DYNAMIC_ISLAND_APPSWITCH_EXPAND_WIDTH=200     # This value should match the notch size, appearence wise
...
#
P_DYNAMIC_ISLAND_VOLUME_EXPAND_WIDTH=200     # This value should match the notch size, appearence wise
