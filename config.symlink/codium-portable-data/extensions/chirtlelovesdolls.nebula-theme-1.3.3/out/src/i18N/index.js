...
const getCurrentLanguage = () => vscode.env.language;
 ...
 */
const initTranslations = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        currentTranslation = yield loadTranslation('en');
 ...
 * */
const getTranslationValue = (key, translations = currentTranslation, fallback = fallbackTranslation) => {
