...
exports.workspaceColors = void 0;
exports.workspaceColors = [
    ...
    { scope: "pickerGroup.foreground", color: "#E752A1" },
    { scope: "pickerGroup.border", color: "#B2CFFB1A" },
    ...
    { scope: "menu.background", color: "#27273A" },
    { scope: "menu.foreground", color: "#919CB9" },
    { scope: "menu.selectionBackground", color: "#899BBF3A" },
    { scope: "menu.selectionForeground", color: "#FCF6FF" },
    { scope: "menu.selectionBorder", color: "#0F13207A", materialize: true },
    ...
    { scope: "settings.inactiveSelectedItemBorder", color: "#B2CFFB1A" },
    { scope: "settings.dropdownBackground", color: "#1F2330" },
    { scope: "settings.dropdownForeground", color: "#E7ADFB" },
    { scope: "settings.dropdownBorder", color: "#B2CFFB1A" },
    { scope: "settings.dropdownListBorder", color: "#B2CFFB1A" },
    { scope: "settings.checkboxBackground", color: "#1F2330" },
    { scope: "settings.checkboxForeground", color: "#97EE91" },
    { scope: "settings.checkboxBorder", color: "#97EE9150" },
    { scope: "settings.textInputBackground", color: "#1F2330" },
    { scope: "settings.textInputForeground", color: "#50DFFE" },
    { scope: "settings.textInputBorder", color: "#B2CFFB1A" },
    { scope: "settings.numberInputBackground", color: "#1F2330" },
    { scope: "settings.numberInputForeground", color: "#F8C275" },
    { scope: "settings.numberInputBorder", color: "#B2CFFB1A" },
    ...
    { scope: "tab.activeModifiedBorder", color: "#E34F8C" },
    { scope: "tab.inactiveModifiedBorder", color: "#E34F8C90" },
    { scope: "tab.unfocusedActiveModifiedBorder", color: "#E34F8CA0" },
    { scope: "tab.unfocusedInactiveModifiedBorder", color: "#E34F8C70" },
    ...
    { scope: "breadcrumb.background", color: "#27273A" },
    ...
    { scope: "sideBarSectionHeader.border", color: "#27273A" },
    ...
    { scope: "dropdown.border", color: "#B2CFFB3A" },
    { scope: "dropdown.background", color: "#1F2330" },
    { scope: "dropdown.foreground", color: "#D7D6DF" },
    { scope: "input.border", color: "#B2CFFB1A" },
    { scope: "input.background", color: "#1F2330" },
    { scope: "input.placeholderForeground", color: "#919CB99c" },
    { scope: "input.foreground", color: "#D7D6DF" },
    { scope: "inputOption.activeBorder", color: "#363C4C" },
    { scope: "inputValidation.infoBorder", color: "#919CB9" },
    { scope: "inputValidation.infoForeground", color: "#D7D6DF" },
    { scope: "inputValidation.infoBackground", color: "#1F2330" },
    { scope: "inputValidation.warningBorder", color: "#F2C88C" },
    { scope: "inputValidation.warningForeground", color: "#F2C88C" },
    { scope: "inputValidation.warningBackground", color: "#1F2330" },
    { scope: "inputValidation.errorBorder", color: "#E34F8C" },
    { scope: "inputValidation.errorForeground", color: "#E34F8C" },
    { scope: "inputValidation.errorBackground", color: "#1F2330" },
    { scope: "diffEditor.insertedTextBackground", color: "#6EEEC425" },
    { scope: "diffEditor.removedTextBackground", color: "#E34F8C25" },
...
//# sourceMappingURL=workspaceColors.js.map